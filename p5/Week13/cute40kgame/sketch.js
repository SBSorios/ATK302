...
function preload() {
  ...
  Defeat = loadSound('Assets/Failure.mp3');
...
function draw() {
  ...
  switch (myState) {
    ...
    //  text("Commander Boreale, today the enemy is at our door! Kill them in the name of the Emperor!", 400, 125);
      ...
      text("You have been spotted by the Tyranids!", 400, 50);
    //  fill('black');
    //  textFont(BlackletterOutline,22);
    //  text("Left Mouse Click to Start", 130, 75);
    fill('black');
    textFont( Japanese, 35);
    text("Attack of the Chibi Nids", 400, 30);
    ...
    //  text("You have 11 seconds to move and touch all the enemies before you are overwhelmed!", 400,100);
      fill('black');
      textFont(  Japanese,20);
      text("You have 10 seconds to headpat them before they eat you!",400, 65); //400,725);
      //fill('black');
      //rect(1,700,8000,40);
      break;
    ...
    case 2: //win state
      ...
      text("The Tyranids are satisfied... for now.", 425, 50);
    //  fill('black');
    //  textFont(BlackletterOutline,22);
  ...
  //  textFont(BlackletterOutline,22);
    ...
    fill(204,0,0);
      textFont( Japanese,30);
    //  textStyle(BOLD);
      text("Good Job! You've doomed the entire galaxy!", 400, 50);
    //  fill('black');
...
function Car() {
  ...
  this.display = function() {
    image(Tyranid, this.pos.x, this.pos.y, 100, 100);
